...
const Register=()=>{
    ...
    <div>
        ...
        <input onChange={inputHandle} value={registerData.name} className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' type="text" name="name" id="name" placeholder='Name' required />
    </div>
    <div className='flex flex-col gap-1 mb-2'>
        <label htmlFor="email">Email</label>
        <input onChange={inputHandle} value={registerData.email}  className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' type="email" name="email" id="email" placeholder='Email' required />
    </div>
    <div className='flex flex-col gap-1 mb-2'>
        <label htmlFor="phone">Phone No</label>
        <input onChange={inputHandle} value={registerData.phone}  className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' type="phone" name="phone" id="phone" placeholder='Phone No' required />
    </div>
    ...
    <div className='flex flex-col gap-1 mb-2'>
        ...
        <input onChange={inputHandle} value={registerData.password}  className='w-full px-3 py-2 border border-slate-200 outline-none focus:border-green-500 rounded-md' type="password" name="password" id="password" placeholder='Password' required />
    </div>
    ...
    <div className='text-center text-slate-600 pt-1'>
        <p>Allready Have An Account ? <Link className='text-blue-500' to='/customerlogin'> Login</Link> </p>
    </div> 
     ...
     <div className='px-8 w-full py-2 bg-[#ad2cc4] shadow hover:shadow-red-500/50 text-white rounded-md flex justify-center items-center gap-2 mb-3'>
            ...
            <img className='mb-6' src="http://localhost:3000/images/login.jpg" alt="" />
            <a target='_blank' href="http://localhost:3001/login">
     <div className='px-8 w-full py-2 bg-[#02e3e0] shadow hover:shadow-red-500/50 text-white rounded-md flex justify-center items-center gap-2 mb-3'>
            Login As a Admin
     </div>
